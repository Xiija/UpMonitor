...
[**Visit the UpMonitor status page →**](https://Xiija.github.io/UpMonitor)
 ...
 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="110" height="20" id="svg1">
      ...
      <g fill="#fff" text-anchor="middle" font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size="110">
        <text id="t1" x="385" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="650">Funkiness</text>
        <text id="t1" x="385" y="140" transform="scale(.1)" textLength="650">Funkiness</text>
        <text id="t2" x="915" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="250">100%</text>
        <text id="t2" x="915" y="140" transform="scale(.1)" textLength="250">100%</text>        
      </g> 
    </svg>
